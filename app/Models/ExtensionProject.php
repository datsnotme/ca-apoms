...
class ExtensionProject extends Model
{
    ...
    {
        return [
            'status' => ExtensionProjectStatus::class,
            'start_date' => 'date',
            'end_date' => 'date',
        ];
    }
    ...
    {
        return $this->hasMany(ExtensionMember::class);
    }
    ...
    /**
     * Same reasoning as ResearchProject::scopeVisibleTo() (Phase 7A): an
     * extension project always belongs to exactly one department — no
     * nullable-meaning-college-wide case here.
     */
