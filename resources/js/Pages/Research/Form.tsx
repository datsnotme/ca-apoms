...
interface ResearchProjectFormValues {
    title: string;
    description: string;
    status: string;
    start_date: string;
...
export default function ResearchProjectForm({
    ...
    action: string;
    method: 'post' | 'put';
    initialValues: Partial<ResearchProjectFormValues>;
    ...
    const { data, setData, post, put, processing, errors } = useForm<ResearchProjectFormValues>({
    ...
    return (
        <form onSubmit={submit} className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            ...
            {isAdmin ? (
                ...
                <p className="self-end text-sm text-slate-500">This project belongs to your own department.</p>
            )}
