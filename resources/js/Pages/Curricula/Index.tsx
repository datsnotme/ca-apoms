        ...
        <AppLayout header={<h1 className="text-lg font-semibold text-slate-900">Curricula</h1>}>
            ...
            <Card>
                <CardHeader
                    ...
                    actions={
                        canManage ? (
                            <PrimaryButton onClick={() => setShowCreate(true)}>Add Curriculum</PrimaryButton>
                        ) : undefined
                    }
                />
            ...
            {canManage && programs && academicYears && (
                <Modal show={showCreate} onClose={() => setShowCreate(false)} maxWidth="2xl" variant="form">
                    <div className="p-6">
                        <h2 className="text-lg font-medium text-slate-900">Add Curriculum</h2>
                        <div className="mt-4">
                            <CurriculumForm
