                            ...
                            {documents.map((doc) => (
                                <tr key={doc.id}>
                                    ...
                                    <td className="px-3 py-2">
                                        ...
                                        {doc.uploaded_by && <div className="text-xs text-slate-900">by {doc.uploaded_by.name}</div>}
                                    </td>
                                    <td className="px-3 py-2">
                                        ...
                                        {doc.verified_by && <div className="text-xs text-slate-900">by {doc.verified_by.name}</div>}
