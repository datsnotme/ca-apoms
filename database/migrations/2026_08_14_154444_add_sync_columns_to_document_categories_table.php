...
return new class extends Migration
{
    public function up(): void
    {
        ...
        DB::table('document_categories')->whereNull('uuid')->orderBy('id')->chunkById(500, function ($rows) {
            foreach ($rows as $row) {
                DB::table('document_categories')->where('id', $row->id)->update(['uuid' => (string) Str::uuid()]);
            }
        });
    }
